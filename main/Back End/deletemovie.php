...
if(isset($submit))
{
 	while($ar=mysqli_fetch_array(mysqli_query($link,"select song_name from mp3songs where movie_name='$t1';")))
	{
		$a=$ar['song_name'];
		rmdir("$a");	
	}
	...
	{
		if(mysqli_query($link,"delete from mp3songs where movie_name='$t1';"))
		{
...
if(isset($del))
{
	header("location:deletemovie2.php");	
}
?>
